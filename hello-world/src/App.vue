<template>
  ...
  <div v-bind:style="[baseStyleObject,succssStyleObject]">Sucess Style</div> -->
  <!--styles written in the last style object overrides previous style object -->
 ...
 -->
  ...
  <!--when show element is false it just not present at all-->
